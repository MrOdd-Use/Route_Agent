...
| `route_agent/monitoring/tests/test_monitoring_module.py` | `monitoring` public service API | Sync + async event recording, recent queries, stats aggregation, exported API surface | `uv run pytest -q route_agent/monitoring/tests/test_monitoring_module.py` |
